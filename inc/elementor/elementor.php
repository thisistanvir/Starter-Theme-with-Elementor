...
final class Starter_Theme_Extension {
	...
	public function register_widgets($widget_manager) {
		...
		// Register Widget
		$widget_manager->register_widget_type(new \Addon_Widget());
	}

	// Enqueue Widget Style
	public function frontend_styles() {
		wp_enqueue_style('slick', get_template_directory_uri() . '/inc/elementor/assets/slick.css', array(), '1.0.0', 'all');
	}

	// Enqueue Widget Scripts
	public function frontend_scripts() {

		wp_enqueue_script('slick', get_template_directory_uri() . '/inc/elementor/assets/slick.min.js', array('jquery'), '1.5.7', true);
	}
}
