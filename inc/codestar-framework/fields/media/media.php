  ...
  class CSF_Field_media extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'preview_height' => '',
        'library'        => array(),
        'button_title'   => esc_html__('Upload', 'starter-theme'),
        'remove_title'   => esc_html__('Remove', 'starter-theme'),
      ...
      $placeholder = (empty($this->field['placeholder'])) ? ' placeholder="' .  esc_html__('Not selected', 'starter-theme') . '"' : '';
