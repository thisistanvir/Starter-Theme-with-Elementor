  ...
  class CSF_Field_group extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'min'                    => 0,
        'fields'                 => array(),
        'button_title'           => esc_html__('Add New', 'starter-theme'),
      ...
      if (preg_match('/' . preg_quote('[' . $this->field['id'] . ']') . '/', $this->unique)) {
        ...
        echo '<div class="csf-notice csf-notice-danger">' . esc_html__('Error: Field ID conflict.', 'starter-theme') . '</div>';
      } else {
        ...
        echo '<i class="csf-cloneable-remove csf-confirm fas fa-times" data-confirm="' . esc_html__('Are you sure to delete this item?', 'starter-theme') . '"></i>';
        echo '</div>';
        ...
        echo '<div class="csf-cloneable-alert csf-cloneable-max">' . esc_html__('You cannot add more.', 'starter-theme') . '</div>';
        echo '<div class="csf-cloneable-alert csf-cloneable-min">' . esc_html__('You cannot remove more.', 'starter-theme') . '</div>';
