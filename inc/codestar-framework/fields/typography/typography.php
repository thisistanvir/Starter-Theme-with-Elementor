  ...
  class CSF_Field_typography extends CSF_Fields {
    ...
    public function render() {
      ...
      if (!empty($args['font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Family', 'starter-theme') . '</div>';
        echo $this->create_select(array($this->value['font-family'] => $this->value['font-family']), 'font-family', esc_html__('Select a font', 'starter-theme'));
        echo '</div>';
      }
      ...
      if (!empty($args['backup_font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Backup Font Family', 'starter-theme') . '</div>';
        echo $this->create_select(apply_filters('csf_field_typography_backup_font_family', array(
          ...
          'Georgia, serif',
          'Palatino Linotype'
        )), 'backup-font-family', esc_html__('Default', 'starter-theme'));
        echo '</div>';
      }
      ...
      if (!empty($args['font_weight']) || !empty($args['font_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Style', 'starter-theme') . '</div>';
        echo '<select class="csf--font-style-select" data-placeholder="Default">';
        echo '<option value="">' . (!$this->chosen ? esc_html__('Default', 'starter-theme') : '') . '</option>';
        ...
        if (!empty($args['extra_styles'])) {
          ...
          echo (!$this->chosen) ? '<div class="csf--title">' . esc_html__('Load Extra Styles', 'starter-theme') . '</div>' : '';
          $placeholder = ($this->chosen) ? esc_html__('Load Extra Styles', 'starter-theme') : esc_html__('Default', 'starter-theme');
      ...
      if (!empty($args['subset'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Subset', 'starter-theme') . '</div>';
        $subset = (is_array($this->value['subset'])) ? $this->value['subset'] : array_filter((array) $this->value['subset']);
        echo $this->create_select($subset, 'subset', esc_html__('Default', 'starter-theme'), $args['multi_subset']);
        echo '</div>';
      }
      ...
      if (!empty($args['text_align'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Align', 'starter-theme') . '</div>';
        echo $this->create_select(array(
          'inherit' => esc_html__('Inherit', 'starter-theme'),
          'left'    => esc_html__('Left', 'starter-theme'),
          'center'  => esc_html__('Center', 'starter-theme'),
          'right'   => esc_html__('Right', 'starter-theme'),
          'justify' => esc_html__('Justify', 'starter-theme'),
          'initial' => esc_html__('Initial', 'starter-theme')
        ), 'text-align', esc_html__('Default', 'starter-theme'));
        echo '</div>';
      }
      ...
      if (!empty($args['font_variant'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Variant', 'starter-theme') . '</div>';
        echo $this->create_select(array(
          'normal'         => esc_html__('Normal', 'starter-theme'),
          'small-caps'     => esc_html__('Small Caps', 'starter-theme'),
          'all-small-caps' => esc_html__('All Small Caps', 'starter-theme')
        ), 'font-variant', esc_html__('Default', 'starter-theme'));
        echo '</div>';
      }
      ...
      if (!empty($args['text_transform'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Transform', 'starter-theme') . '</div>';
        echo $this->create_select(array(
          'none'       => esc_html__('None', 'starter-theme'),
          'capitalize' => esc_html__('Capitalize', 'starter-theme'),
          'uppercase'  => esc_html__('Uppercase', 'starter-theme'),
          'lowercase'  => esc_html__('Lowercase', 'starter-theme')
        ), 'text-transform', esc_html__('Default', 'starter-theme'));
        echo '</div>';
      }
      ...
      if (!empty($args['text_decoration'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Decoration', 'starter-theme') . '</div>';
        echo $this->create_select(array(
          'none'               => esc_html__('None', 'starter-theme'),
          'underline'          => esc_html__('Solid', 'starter-theme'),
          'underline double'   => esc_html__('Double', 'starter-theme'),
          'underline dotted'   => esc_html__('Dotted', 'starter-theme'),
          'underline dashed'   => esc_html__('Dashed', 'starter-theme'),
          'underline wavy'     => esc_html__('Wavy', 'starter-theme'),
          'underline overline' => esc_html__('Overline', 'starter-theme'),
          'line-through'       => esc_html__('Line-through', 'starter-theme')
        ), 'text-decoration', esc_html__('Default', 'starter-theme'));
        echo '</div>';
      }
      ...
      if (!empty($args['font_size'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Size', 'starter-theme') . '</div>';
      ...
      if (!empty($args['line_height'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Line Height', 'starter-theme') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (!empty($args['letter_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Letter Spacing', 'starter-theme') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (!empty($args['word_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Word Spacing', 'starter-theme') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (!empty($args['color'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Color', 'starter-theme') . '</div>';
      ...
      if (!empty($args['custom_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Custom Style', 'starter-theme') . '</div>';
    ...
    public function enqueue() {
      ...
      if (!wp_script_is('csf-webfontloader')) {
        ...
        wp_enqueue_script('csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array('starter-theme'), '1.6.28', true);
        ...
        if (!empty($customwebfonts)) {
          $webfonts['custom'] = array(
            'label' => esc_html__('Custom Web Fonts', 'starter-theme'),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__('Safe Web Fonts', 'starter-theme'),
          'fonts' => apply_filters(
        ...
        $webfonts['google'] = array(
          'label' => esc_html__('Google Web Fonts', 'starter-theme'),
          'fonts' => apply_filters(
        ...
        wp_localize_script('starter-theme', 'csf_typography_json', array(
          'webfonts'      => $webfonts,
