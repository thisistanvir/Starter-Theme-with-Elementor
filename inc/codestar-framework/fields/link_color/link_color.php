...
if (!class_exists('CSF_Field_link_color')) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__('Normal', 'starter-theme'),
        'hover'    => esc_html__('Hover', 'starter-theme'),
        'active'   => esc_html__('Active', 'starter-theme'),
        'visited'  => esc_html__('Visited', 'starter-theme'),
        'focus'    => esc_html__('Focus', 'starter-theme')
      );
