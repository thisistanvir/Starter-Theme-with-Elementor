  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'top_placeholder'    => esc_html__('top', 'starter-theme'),
        'right_placeholder'  => esc_html__('right', 'starter-theme'),
        'bottom_placeholder' => esc_html__('bottom', 'starter-theme'),
        'left_placeholder'   => esc_html__('left', 'starter-theme'),
        'all_placeholder'    => esc_html__('all', 'starter-theme'),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__('Solid', 'starter-theme'),
        'dashed'    => esc_html__('Dashed', 'starter-theme'),
        'dotted'    => esc_html__('Dotted', 'starter-theme'),
        'double'    => esc_html__('Double', 'starter-theme'),
        'inset'     => esc_html__('Inset', 'starter-theme'),
        'outset'    => esc_html__('Outset', 'starter-theme'),
        'groove'    => esc_html__('Groove', 'starter-theme'),
        'ridge'     => esc_html__('ridge', 'starter-theme'),
