  ...
  class CSF_Metabox extends CSF_Abstract {
    ...
    public function add_meta_box_content($post, $callback) {
      ...
      if (!empty($this->args['show_restore']) || !empty($this->args['show_reset'])) {
        ...
        echo '<span class="button csf-button-reset">' . esc_html__('Reset', 'starter-theme') . '</span>';
        echo '<span class="button csf-button-cancel">' . sprintf('<small>( %s )</small> %s', esc_html__('update post', 'starter-theme'), esc_html__('Cancel', 'starter-theme')) . '</span>';
        echo '</label>';
        echo '</div>';
      }
